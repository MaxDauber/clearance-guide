const fclSteps = [
  ...
  },
  {
    ...
    content: `NISS = <strong>National Industrial Security System</strong>. This is DCSA's online portal where your company formally enters the clearance process. Your sponsor initiates this by telling DCSA "we need this company cleared." You'll create an account and begin submitting your facility clearance package.`,
    bullets: [
  ...
  },
  {
    ...
    callout: {
      type: 'info',
      text: '<strong>Pro tip:</strong> Don\'t wait for the SVA to set up your security infrastructure. Have your safes, alarm systems, and written procedures in place before DCSA comes. The SVA is a pass/fail gate, and failing means rework and delay.',
    },
  },
  {
    title: 'FCL Granted!',
    ...
    callout: {
      type: 'success',
      text: '<strong>FCL levels:</strong> Your FCL level determines the highest classification of work you can perform. A Secret FCL lets you work Secret and below. A Top Secret FCL lets you work all levels. Most companies start with Secret, which covers ~80% of classified contracts.',
    },
  },
];
