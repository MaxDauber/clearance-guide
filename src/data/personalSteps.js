const personalSteps = [
  ...
  },
  {
    ...
    callout: {
      type: 'success',
      text: "<strong>Don't panic.</strong> The SF86 looks intimidating, but the #1 rule is: <strong>be honest.</strong> They're looking for honesty and trustworthiness above all. People with past drug use, financial issues, and even minor criminal records get cleared every day, as long as they're truthful about it.",
    },
  },
  {
