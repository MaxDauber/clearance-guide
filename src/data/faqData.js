const faqData = [
  ...
  },
  {
    ...
    answer: `<p><strong>Secret</strong> gives you access to information that could cause "serious damage" to national security if disclosed. Most cleared personnel hold Secret.</p><p><strong>Top Secret (TS)</strong> covers information that could cause "exceptionally grave damage." Requires a more thorough investigation.</p><p><strong>TS/SCI</strong> (Sensitive Compartmented Information) is an <em>access designation</em> layered on top of TS, rather than a separate clearance level. It means you can access specific intelligence programs. You need TS clearance <em>plus</em> SCI access granted by the intelligence community, usually requiring a polygraph and additional adjudication.</p>`,
  },
  {
