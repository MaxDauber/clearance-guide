...
const atoFaqs = [
  ...
  },
  {
    ...
    a: 'Assessments produce <strong>findings</strong> rather than a pass/fail verdict. Every finding goes into your POA&M with a remediation plan and timeline. The AO then decides whether the residual risk is acceptable. Common outcomes:<br/><ul><li>ATO with Conditions: authorized, but you must fix specific issues by specific dates</li><li>IATO: temporary authorization while you remediate</li><li>DATO: denied, but you can fix issues and resubmit</li></ul>The key is demonstrating a credible remediation plan. AOs rarely issue DATOs unless there are fundamental architectural security problems.',
  },
  {
    ...
    <>
      ...
      <main>
        ...
        <PhaseSection id="categorize" number="02" title="Categorize the System" subtitle="FIPS 199: determining your security impact level">
          ...
          >
            <p>
              National Security Systems (NSS), which handle classified info or are critical to military/intelligence operations, use
        ...
        <PhaseSection id="select" number="03" title="Select Security Controls" subtitle="NIST SP 800-53: building your control baseline">
          ...
          >
            ...
            <ul>
              ...
              <li><strong>Organization-defined parameters:</strong> Many controls have blanks you fill in (e.g., "lock account after [X] failed login attempts," where your org defines X).</li>
        ...
        <PhaseSection id="implement" number="04" title="Implement Controls" subtitle="Building security into the system">
          ...
          >
            <p>
              The SSP is your magnum opus. It documents <strong>every</strong> control implementation, describing how your system meets each requirement. For a Moderate system, you're writing implementation descriptions for ~325 controls.
            </p>
        ...
        {/* ─── PHASE 7: MONITOR ─── */}
        <PhaseSection id="monitor" number="07" title="Continuous Monitoring" subtitle="ATO is the starting line, with monitoring obligations that continue for the life of the system">
