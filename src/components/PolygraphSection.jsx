...
const expectItems = [
  ...
  { title: 'The Process', text: "Pre-test interview (examiner explains everything and reviews questions), the actual polygraph (sensors attached, questions asked), and post-test discussion. It's designed to feel intense, and that's the point." },
  ...
  { title: 'Inconclusive?', text: 'Not necessarily disqualifying. Inconclusive results are common, and you\'ll likely be asked to retake. A "failed" poly leads to further review, not automatic denial. Many people pass on the second attempt.' },
];
