      ...
      <Reveal>
        <div className="pull-quote">
          <p className="pull-quote__text" style={{ fontSize: 'clamp(1.1rem, 2vw, 1.5rem)', color: '#666' }}>
            Common gotchas: Incomplete FOCI documentation (the #1 delay), not having an FSO ready, underestimating the time commitment, and not starting KMP clearances early enough; they need personal clearances too.
          </p>
        </div>
      </Reveal>
    </section>
